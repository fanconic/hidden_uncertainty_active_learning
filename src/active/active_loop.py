# Taken fronm https://github.com/ElementAI/baal/blob/a9cc0034c40d0541234a3c27ff5ccbd97278bcb3/baal/active/active_loop.py#L15
...
class ActiveLearningLoop:
    ...
    Args:
        ...
        heuristic (Heuristic): Heuristic from active.heuristics.
